...
use crate::ax_interaction::{
    focused_uielement_of_app, is_focused_uielement_of_app_replit_editor_field,
};

pub fn get_replit_editor_content(pid: pid_t) -> Result<Option<String>, Error> {
    if is_focused_uielement_of_app_replit_editor_field(pid)? {
...
pub fn update_replit_editor_content(pid: pid_t, content: &str) -> Result<bool, Error> {
    if is_focused_uielement_of_app_replit_editor_field(pid)? {
        let editor_element = focused_uielement_of_app(pid)?;
