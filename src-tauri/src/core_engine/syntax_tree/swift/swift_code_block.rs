...
/*
// https://github.com/alex-pinkus/tree-sitter-swift/blob/main/corpus/statements.txt
pub fn is_statement(kind: String) -> bool {
    [
...
pub fn is_expression(kind: String) -> bool {
    [
