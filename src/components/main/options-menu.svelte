...
<Menu as="div" class="relative">
	<MenuButton as="div" class="absolute top-0 right-0 outline-none">
		<button type="button" class="bg-white rounded-md text-gray-400 hover:text-gray-500 m-2">
	...
	>
		...
		>
			<div class="hover:bg-gray-100">
				<MenuItem let:active>
					<Link href="/content"
						><button type="button" class="block px-4 py-2 text-sm text-gray-700">Alerts</button
						></Link
					>
				</MenuItem>
			</div>
			<div class="hover:bg-gray-100">
				<MenuItem let:active>
					<Link href="/content/search-replace"
						><button type="button" class="block px-4 py-2 text-sm text-gray-700"
